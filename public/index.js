...
var showAlert = function showAlert(type, msg) {
  ...
  if (currentAlert) currentAlert.remove(); // create a new alert element

  var element = document.createElement('div');
  element.classList.add('alert', "alert--".concat(type));
  element.textContent = msg; // insert it into the body

  document.querySelector('body').insertAdjacentElement('afterbegin', element); // shrink it before removing

  setTimeout(function () {
    element.classList.add('collapse');
  }, timeout - 100); // //remove it after some time
  // setTimeout(() => {
  //   element.remove();
  // }, timeout);
};
...
exports.updateMyPassword = exports.updateMyData = void 0;
...
var reloadAfterUpdate = function reloadAfterUpdate() {
  setTimeout(location.reload.bind(location, true), 1500);
};

var updateMyData = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Account settings successfully updates');
              reloadAfterUpdate();
            }
  ...
  return function updateMyData(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var updateMyPassword = /*#__PURE__*/function () {
  ...
  return function updateMyPassword(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2lkZGhhcnRoYm9yZGVyd2FsYSIsImEiOiJja2g0ZnFsNDQwMTVrMnluMW9tMDlvdDF2In0.IJ-netZroHXa82baJL9AqA';
...
var form = document.querySelector('form.form__login');
var logoutButton = document.querySelector('.nav__el--logout');
var updateMyDataForm = document.querySelector('form.form-user-data');
var updateMyPasswordForm = document.querySelector('form.form-user-settings');
...
if (updateMyDataForm) {
  updateMyDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    (0, _updateSettings.updateMyData)(form);
  });
}

if (updateMyPasswordForm) {
  updateMyPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var passwordCurrent = document.getElementById('password-current').value;
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('password-confirm').value;
    (0, _updateSettings.updateMyPassword)(passwordCurrent, password, passwordConfirm);
  });
}
